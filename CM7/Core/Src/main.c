...
/* USER CODE BEGIN PFP */
#define  i2c_write(x,y,z) HAL_I2C_Master_Transmit(&hi2c1, x, y, z, 0xFFFF)
...
char data[2];
  ...
  data[0]=0x4F;
  data[1]=0x0;
  i2c_write(8 << 1, data, sizeof(data));
  data[0]=0x50;
  data[1]=0xF;
  i2c_write(8 << 1, data, sizeof(data));
  ...
  HAL_GPIO_WritePin(GPIOK, LED_RED_Pin|LED_GREEN_Pin|LED_BLUE_Pin, GPIO_PIN_SET);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOK, LED_RED_Pin|LED_GREEN_Pin|LED_BLUE_Pin|VIDEO_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOJ, ETHERNET_NRST_Pin|BLE_DEVICE_WAKE_Pin|BLE_ON_Pin|OTG_EN_Pin
                          |WIFI_ON_Pin|VIDEO_RST_N_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CRYPTO_EN_GPIO_Port, CRYPTO_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_RED_Pin LED_GREEN_Pin LED_BLUE_Pin VIDEO_EN_Pin */
  GPIO_InitStruct.Pin = LED_RED_Pin|LED_GREEN_Pin|LED_BLUE_Pin|VIDEO_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : ETHERNET_NRST_Pin BLE_DEVICE_WAKE_Pin BLE_ON_Pin OTG_EN_Pin
                           WIFI_ON_Pin VIDEO_RST_N_Pin USB_RESET_Pin */
  GPIO_InitStruct.Pin = ETHERNET_NRST_Pin|BLE_DEVICE_WAKE_Pin|BLE_ON_Pin|OTG_EN_Pin
                          |WIFI_ON_Pin|VIDEO_RST_N_Pin|USB_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : BLE_HOST_WAKE_Pin */
  GPIO_InitStruct.Pin = BLE_HOST_WAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BLE_HOST_WAKE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CRYPTO_EN_Pin */
  GPIO_InitStruct.Pin = CRYPTO_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CRYPTO_EN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : CLOCK_EN_Pin */
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PMIC_STANDBY_GPIO_Port, &GPIO_InitStruct);
